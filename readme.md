<div align="center">
  ...
  <br/><br/>
  <p><strong>Port of <a href="https://github.com/vectrix-space/ignite">Ignite.</a></strong> A <a href="https://github.com/SpongePowered/Mixin">Mixin</a> loader for PowernukkitX.</p>
  <br/>
</div>
...
Download the `ignite.jar` from the [releases page](https://github.com/Kanelucky/ignite-powernukkitx/releases).

Place the ignite.jar into the same directory with your powernukkitx.jar.

Run server with java -jar ignite.jar
